...
describe("Redux_ICO", function () {
    ...
    it("Should set correct Params for the PreSale contract", async function(){
        ...
        await expect(presale.setSaleTokenParams("20000000000000000000000000", String(10**18), 2)).to.be.revertedWith("Redux Presale: Round ID should be 0 or 1")
    ...
    it("Should set external vesting", async function(){
        ...
        await expect(presale.setExternalAllocation(
            team, amount, 2
        )).to.be.revertedWith("Redux: Id should be greater than 1")
    ...
    it("Should allow users to withdraw Sale Token.", async function(){
        ...
        .to.be.revertedWith("Redux Token Vesting: No $REDUX Tokens available for claim!");
        await presale.connect(accountB).withdrawToken();
